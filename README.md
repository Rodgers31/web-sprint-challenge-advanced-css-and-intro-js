...
1. How would you describe acessibility on the web to someone new to programming?
   Beaing able to view your website in different screen sizes.
2. Talk about 3 different things you can do to ensure your website is accessible.
   Make sure to add media quaries, add descriptions in alt tags for visualy impared users, think about contrast sensitivity for people who are visually impared.
3. How would you explain the concept of a variable to someone new to programming?
   they are basicaly storages used to store data
4. What is the purpose of using functions in code?
   they are holding blocks, that are used to performs tasks or calculate values
